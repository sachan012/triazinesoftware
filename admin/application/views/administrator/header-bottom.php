<?php
 if ($this->session -> userdata('email') == "" && $this->session -> userdata('login') != true && $this->session -> userdata('role_id') != 1) {
   ...
   $class = $this->router->fetch_class();  echo "&nbsp;&nbsp;&nbsp;&nbsp;";
    ...
    <div class="main-menu">
        ...
        <div class="main-menu-content">
            <ul class="main-navigation">
             <li class="nav-item <?php if($class == "administrator" && $methode == "dashboard") { echo "has-class"; }?>">
                ...
                <li class="nav-item <?php if($class == "administrator" && $methode == "add_user" || $methode == "users" || $methode == "update_user") { echo "has-class"; }?>">
                    <a href="#!">
                        <i class="ti-layout"></i>
                        <span>Users</span>
                    </a>
                    <ul class="tree-1">
                        <li class="<?php if($class == "administrator" && $methode == "add_user") { echo "has-class"; }?>"><a href="<?php echo base_url();?>administrator/users/add-user">Add User</a></li>
                        <li class="<?php if($class == "administrator" && $methode == "users") { echo "has-class"; }?>"><a href="<?php echo base_url(); ?>administrator/users/users">Users</a></li>
                    </ul>
                </li>
                    <li class="nav-item <?php if($class == "administrator" && $methode == "add_blog" || $methode == "list_blog" || $methode == "list_blog_comments" || $methode == "update_blog") { echo "has-class"; }?>">
                        <a href="#!">
                            <i class="ti-layers"></i>
                            <span>Blogs</span>
                        </a>
                        <ul class="tree-1">
                            <!-- <li class="nav-sub-item"><a href="#">Blogs</a>
                                <ul class="tree-2"> -->
                                    <li class="<?php if($class == "administrator" && $methode == "add_blog") { echo "has-class"; }?>"><a href="<?php echo base_url(); ?>administrator/blogs/add-blog">Add Blogs</a></li>
                                    <li class="<?php if($class == "administrator" && $methode == "list_blog") { echo "has-class"; }?>"><a href="<?php echo base_url(); ?>administrator/blogs/list-blog">List Blogs</a></li>
                                    <li class="<?php if($class == "administrator" && $methode == "list_blog_comments") { echo "has-class"; }?>"><a href="<?php echo base_url(); ?>administrator/blogs/blog-comments">Comments</a></li>
                               <!--  </ul>
                            </li> -->
              ...
              <li class="nav-item <?php if($class == "administrator" && $methode == "create_product_category" || $methode == "product_categories" || $methode == "update_product_category") { echo "has-class"; }?>">
                    <a href="#!">
                        <i class="ti-layout"></i>
                        <span>Category</span>
                    </a>
                    <ul class="tree-1">
                       <li class="<?php if($class == "administrator" && $methode == "create_product_category") { echo "has-class"; }?>"><a href="<?php echo base_url(); ?>administrator/product-categories/create">Add Category</a></li>
                       <li class="<?php if($class == "administrator" && $methode == "product_categories") { echo "has-class"; }?>"><a href="<?php echo base_url(); ?>administrator/product-categories">List Category</a></
                    </ul>
                </li>
