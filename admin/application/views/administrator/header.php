            ...
            <div class="navbar-logo">
                ...
                <a href="<?php echo base_url(); ?>administrator/dashboard">
                 <?php if($this->session->userdata('image') != ""){ ?>
                        <img src="<?php echo base_url(); ?>assets/images/<?php echo $this->session->userdata('site_logo'); ?>" alt="Site Logo" class="img-fluid" style="width: auto; height: 65px; width: 162px;">
                    <?php }else{ ?>
