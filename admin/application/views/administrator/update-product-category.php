                             ...
                             <div class="col-sm-8">
                               ...
                               <input type="hidden" name="id" value="<?php echo $productcategory['id']; ?>">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <textarea id="editor1" class="form-control" name="full_desc" placeholder="Full Description">
                                            <?php echo $productcategory['full_description']; ?>
                                        </textarea> 
                                    </div>

                                    <?php if(!empty($productcategory['image'])){?>

                                    <div class="form-group row">
                                        <label class="col-form-label"><strong>Product Image</strong></label>
                                    </div>
                                    <div class="form-group row">                                       
                                        <img src="<?php echo base_url().'assets/images/category/'.$productcategory['image'];?>" class="post-thumbnail" width="200">                                       
                                    </div>

                                    <?php } ?>

                                    <div class="form-group row">
                                        <label >Ubdate Image</label>
                                        <input type="file" class="form-control" name="category_image" placeholder="Add Category Image" value="<?php echo set_value('category_image');?>">
                                    </div>
