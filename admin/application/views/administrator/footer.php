 ...
 <!-- Warning Section Ends -->
   ...
   <script src="<?php echo base_url(); ?>admintemplate/bower_components/datatables.net/js/jquery.dataTables.min.js"></script>
    ...
    <!--Taginput-->
    <script src="<?php echo base_url(); ?>admintemplate/assets/js/bootstrap-tagsinput.js"></script>
    <!---CK EDITOR --->
    ...
    $(document).ready(function(){ 
        $('#upload_form').submit(function(e){           
            e.preventDefault(); 
                 $.ajax({
                     url:'<?php echo base_url();?>administrator/uploadImage',
                     type:"post",
                 ...
                 url="<?= base_url('/assets/images/postsDesc/');?>";
                 url= url+json.image_path;
                 
                         var trHTML = `<div><input  class="form-control" type="text" value="`+url+`"></div>`;
