                             ...
                             <div class="col-sm-8">
                               <?php echo form_open_multipart('administrator/create_product_category'); ?>
                                    <div class="form-group row">
                                        ...
                                        <input type="text" name="name" class="form-control" placeholder="Category Name" value="<?php echo set_value('name'); ?>">
                                    ...
                                    <div class="form-group row">
                                      ...
                                      <div class="form-group row">
                                        ...
                                        <textarea id="editor1" class="form-control" name="full_desc" placeholder="Full Description">
                                            <?php echo set_value('full_desc'); ?>
                                        </textarea> 
                                         <?php echo form_error('full_desc', '<div class="error text-danger">', '</div>'); ?>
                                      </div>
                                      ...
                                      <div class="form-group row">
                                        ...
                                        <?php echo form_error('category_image', '<div class="error text-danger">', '</div>'); ?>
                                      </div>
